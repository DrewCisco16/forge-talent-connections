...
def conforming(root):
    ...
    close1 = ("OPTIONS\n1. Fable closes, Astra reviews. [1][3]\n2. Astra closes, Fable reviews. [2]\nKILLS\nnone\nOPEN\n- Claim 4 judgement call: settle with a fidelity benchmark\nMETRICS\noptions_created=2 options_standing=2 claims_total=4 claims_checkable=3 passed=3 failed=0 judgement=1 not_testable=0 blocked=0 inconclusive=0 earned_kills=0 deprioritized=0\n")
...
FAULTS = {
    ...
    "F20_aborted_slot_counted": lambda r: edit(r, "capture.jsonl", '"dispatch_id": "d-02-G2", "file": "stage-02-fmea/seat-G2.md", "completion_signal_observed": true', '"dispatch_id": "d-02-G2", "file": "stage-02-fmea/seat-G2.md", "completion_signal_observed": true, "aborted": true'),
...
GUARD_TESTS = [
    ...
    ("G11_allow_send_after_aborted_slot", lambda r: edit(r, "capture.jsonl", '"dispatch_id": "d-02-G1", "file": "stage-02-fmea/seat-G1.md", "completion_signal_observed": true', '"dispatch_id": "d-02-G1", "file": "stage-02-fmea/seat-G1.md", "completion_signal_observed": false, "aborted": true, "partial": true'), "SEND", ["--seat", "G1"], False),
]
