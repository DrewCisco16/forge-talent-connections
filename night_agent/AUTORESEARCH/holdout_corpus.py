...
FAULTS = [
    ...
    ("S03b", "HOLDOUT", "hybrid", "DISPATCH 6", "a seat file exists with no log record of its write",
    ...
    ("F06b", "HOLDOUT", "hybrid", "10", "ledger carries a flag name the schema does not define",
    ...
    ("X02b", "HOLDOUT", "hybrid", "5 COMPARE", "KEEP with a guardrail beyond tolerance",
    ...
    ("D01b", "HOLDOUT", "direct", "DISPATCH 5", "DIRECT stage has two generator replies",
...
GUARD_BLOCK = [
    ...
    ("GA01b", "HOLDOUT", "hybrid", "7, 15 G-11", "send to a seat that is not READY",
    ...
    ("GA03b", "HOLDOUT", "hybrid", "5, 15 G-9", "KEEP with a guardrail beyond tolerance",
    ...
    ("GA08b", "HOLDOUT", "hybrid", "7, 15 G-6", "REVIEW when the REVIEWER seat is not READY",
    ...
    ("GA09b", "HOLDOUT", "hybrid", "4.7, 15 G-7", "FINAL when metrics-summary.json is not valid JSON",
    ...
    ("GA10b", "HOLDOUT", "hybrid", "4.8, I3, 15 G-8", "VERIFY when section 14 of DELIVERABLE.md already has content",
